<template>
  ...
  >
    <div class="w-full max-w-[1600px] mx-auto px-4 py-2 md:px-6 flex items-center justify-center gap-2">
      <span class="flex items-center gap-1.5 text-[var(--label-size)] text-[var(--color-text-muted)]">
        <span
...
const showConnectButton = computed(() => !isConnected.value && fmStatus.value !== 'connecting')
